...
public class Trooper1 extends MovableObject {
    private int speed = 40;
    private Image bodyImg = new Image("file:src/TowerDefense/AssetsKit_2/PNG/Retina/towerDefense_tile248.png");
    ...
    public Trooper1(Group root, Player player) {
        super(root,player);
